...
public class ClingToCliff extends Action {
    ...
    public boolean canStart(Player player, Parkourability parkourability, ByteBuffer startInfo) {
        boolean value = (player.getDeltaMovement().y() < 0.2
                ...
                && (KeyBindings.getKeyGrabWall().equals(KeyBindings.getKeySneak()) || !player.isShiftKeyDown())
        );
    ...
    private boolean isGrabbing() {
        return ParCoolConfig.Client.getInstance().clingToCliffControl.get() == ParCoolConfig.Client.ClingToCliffControl.PressKey
                ? KeyBindings.getKeyGrabWall().isDown()
    ...
    public void onStartInLocalClient(Player player, Parkourability parkourability, ByteBuffer startData) {
        ...
        armSwingAmount = 0;
        if (!KeyBindings.getKeyGrabWall().equals(KeyBindings.getKeySneak())) {
