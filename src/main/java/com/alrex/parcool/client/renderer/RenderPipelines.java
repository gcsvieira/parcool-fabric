...
public class RenderPipelines {
    private static final RenderPipeline.Snippet ZIPLINE_SNIPPET = RenderPipeline.builder(net.minecraft.client.renderer.RenderPipelines.MATRICES_FOG_SNIPPET)
        .withVertexShader(Identifier.fromNamespaceAndPath("minecraft", "core/rendertype_leash"))
        .withFragmentShader(Identifier.fromNamespaceAndPath("minecraft", "core/rendertype_leash"))
