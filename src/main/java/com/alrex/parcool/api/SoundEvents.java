...
public class SoundEvents {
    ...
    public static final Holder<SoundEvent> BREAKFALL_JUST_TIME = register("breakfall.just");
    public static final Holder<SoundEvent> ROLL = register("breakfall.roll");
    public static final Holder<SoundEvent> SAFETY_TAP = register("breakfall.tap");
    ...
    public static final Holder<SoundEvent> CLING_TO_CLIFF = register("cling_to_cliff.grab");
    public static final Holder<SoundEvent> CLING_TO_CLIFF_JUMP = register("cling_to_cliff.jump");
    public static final Holder<SoundEvent> HANG_DOWN = register("hang_down.grab");
